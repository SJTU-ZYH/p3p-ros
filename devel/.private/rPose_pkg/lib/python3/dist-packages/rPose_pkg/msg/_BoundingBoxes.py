...
"""autogenerated by genpy from rPose_pkg/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','rPose_pkg/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rPose_pkg.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
